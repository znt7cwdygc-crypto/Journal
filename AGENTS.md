...
## ⚠️ ПЕРВОЕ ДЕЙСТВИЕ ПЕРЕД ЛЮБОЙ ЗАДАЧЕЙ

Прочитай `.claude/skills/git-workflow.md` — там правила работы с git.
Создай feature-ветку ДО первого коммита. НИКОГДА не коммить в main напрямую.
