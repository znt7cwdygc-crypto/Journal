...
export function ProductImageInput({
  ...
  return (
    <div className="space-y-3">
      ...
      {!preview ? (
        <button
          className={`flex w-full cursor-pointer flex-col items-center justify-center rounded-xl border border-dashed px-5 py-7 text-center transition ${
        ...
        >
          ...
          <span className="text-sm font-semibold text-ink">Перетащите фото или нажмите для выбора</span>
        ...
        <div className="flex items-center gap-3 rounded-xl border border-zinc-200 bg-white p-3">
          <img className="h-16 w-16 flex-none rounded-lg object-cover" src={preview} alt={title || "Фото товара"} />
      ...
      <div className="flex gap-2 rounded-xl bg-cyan-50 px-3 py-3 text-xs leading-5 text-cyan-900">
