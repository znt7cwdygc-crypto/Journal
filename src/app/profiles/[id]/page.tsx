          ...
          <div className="min-w-0">
            ...
            {user.profileKind !== "MODEL" && user.externalLink && user.externalLinkActive && (
              <a
                ...
                className={`mt-3 inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-semibold text-white shadow-sm ${
                  /t\.me\/|telegram\.me\//.test(user.externalLink) ? "bg-[#2AABEE] hover:bg-[#229ED9]" : "bg-ink hover:bg-zinc-800"
                }`}
              >
                {/t\.me\/|telegram\.me\//.test(user.externalLink) ? (
                  ...
                  <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 0 20 15.3 15.3 0 0 1 0-20z"/></svg>
                )}
